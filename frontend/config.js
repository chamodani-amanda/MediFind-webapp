...
window.MEDIFIND_API_URL = window.MEDIFIND_API_URL || 'https://medifind-webapp-backend.onrender.com/api';
...
window.MEDIFIND_GOOGLE_MAPS_API_KEY = window.MEDIFIND_GOOGLE_MAPS_API_KEY || '';
